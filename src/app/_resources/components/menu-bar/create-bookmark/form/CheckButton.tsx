...
> = ({ children, isSelected, className, ...props }) => {
  return (
    <Button
      variant="secondary"
      className={cn(
        "relative flex items-center gap-x-1 overflow-hidden bg-slate-100 py-4 text-slate-500 transition-all duration-150 lg:py-0 [&>svg]:translate-x-full [&>svg]:opacity-0",
        isSelected &&
